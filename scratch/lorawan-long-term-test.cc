...
int main (int argc, char *argv[])
{
  ...
  //printf("dr after set: %u\r\n", dr);

  dr &= (0b111); //this is a hack, ask Shahwaiz about it.

  //printf("dr after fiddle: %u\r\n", dr);
  //printf("%u\n", dr);
 ...
 */
  ...
  {
  //  std::cout << energySources.GetSize() << std::endl;
    //double avg_energy_cons = ((18000 - energySources.Get(i-1)->GetRemainingEnergy() ) / 3.0 ) / 86400;
    //std::cout << avg_energy_cons << std::endl;
    std::cout << 18000 - energySources.Get(i-1)->GetRemainingEnergy() << "\t";
  }
  std::cout << std::endl;
